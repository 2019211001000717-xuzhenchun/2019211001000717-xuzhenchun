        ...
        <div class="table-responsive col-sm-10">
            <table class="table table-condensed">
                ...
                <tr>
                    ...
                    <td>order Date</td>
                    <%
                        com.xuzhenchun.model.Order o=(com.xuzhenchun.model.Order)pageContext.findAttribute("o");
                        int userId=o.getCustomerId();
                        java.sql.Connection con=(java.sql.Connection)application.getAttribute("con");
                        com.xuzhenchun.dao.UserDao userDao=new com.xuzhenchun.dao.UserDao();
                    ...
                    <td class="cart_total">
                        <%
                            ...
                            String paymentType=com.xuzhenchun.model.Payment.findByPaymentId(con,n);
                        %>
